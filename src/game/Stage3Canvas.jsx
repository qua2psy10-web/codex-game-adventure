...
const PLATFORM_DEFS = [
  ...
  {id:'flash-a',x:-5,y:4,z:-28,w:5,d:5,lightning:true,period:14,visibleFor:12,phase:0},
  {id:'flash-b',x:0,y:5,z:-36,w:5,d:5,lightning:true,period:13,visibleFor:11,phase:1},
